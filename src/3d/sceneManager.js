...
/** ORIGEN — Scene Manager v3
 * Cinematic winter Sierra + adaptive rendering profile.
 */
export class SceneManager {
  constructor(canvas){
    this.canvas=canvas;this.scene=null;this.camera=null;this.renderer=null;this.particles=null;this.lights={};this.clock=new THREE.Clock();this.animationCallbacks=[];this.isDisposed=false;this.pedestalGroup=null;this.profile=getPerformanceProfile();this.init();
  }
  init(){
    this.scene=new THREE.Scene();
    const loader=new THREE.TextureLoader();
    loader.load('/images/origen_panoramic_background.jpg',(texture)=>{texture.colorSpace=THREE.SRGBColorSpace;texture.mapping=THREE.UVMapping;this.scene.background=texture;this.scene.environment=null},undefined,()=>{this.scene.background=new THREE.Color(0x111318)});
